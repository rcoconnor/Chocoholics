...
public class ManagerLogin extends javax.swing.JFrame {
  ...
  private static final long serialVersionUID = -6518058318517825896L;
  ...
  /**
   * This is the method call to display this window from another class or method.
   * @author Emerson
   */
  public void display() {
  ...
  private void oneButtonActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    if (controller.doesExist(loginID)) {
      ...
      JOptionPane.showMessageDialog(null,
          "Incorrect Login", "ERROR", JOptionPane.ERROR_MESSAGE);
      return;
    }
  }
}